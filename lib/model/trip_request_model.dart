...
class TripDetails {
  ...
  // ^ stamped locally, right when this object is constructed (i.e. when socket data arrives)
  ...
  /// Local countdown deadline — always "now + 15s" from the moment this
  /// TripDetails was constructed (i.e. when the socket payload arrived).
  /// Backend requestedAt/expiresAt are NOT used for this.
  ...
  factory TripDetails.fromJson(Map<String, dynamic> json) {
    ...
    return TripDetails(
      ...
      // expiresAt is NOT parsed from json anymore — it's always set locally
      // in the constructor at "now + 15s" the moment this object is built.
